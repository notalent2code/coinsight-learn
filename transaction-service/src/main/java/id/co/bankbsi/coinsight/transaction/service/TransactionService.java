...
public class TransactionService {
        ...
        @CacheEvict(cacheNames = {"transactionSummary", "transactionsList", "transactionsByDateRange"}, allEntries = true)
        @Transactional
        ...
        @Cacheable(value = "transactionsList", key = "'user:' + @userUtility.getCurrentUserId() + ':page:' + #page + ':size:' + #size")
        @Transactional(readOnly = true)
        ...
        @Cacheable(value = "transactionsByDateRange", key = "'user:' + @userUtility.getCurrentUserId() + ':start:' + #startDate + ':end:' + #endDate + ':page:' + #page + ':size:' + #size")
        @Transactional(readOnly = true)
        public PageResponse<TransactionResponse> getTransactionsByDateRange(
                        LocalDate startDate, LocalDate endDate, int page, int size) {
                UUID userId = getCurrentUserId();
                log.info("Fetching transactions for user {} from {} to {}, page {}, size {}", userId, startDate, endDate, page, size);
        ...
        @Cacheable(value = "transactionSummary", key = "#startDate + '-' + #endDate + '-' + @userUtility.getCurrentUserId()")
        @Transactional(readOnly = true)
        public TransactionSummaryResponse getTransactionSummary(LocalDate startDate, LocalDate endDate) {
                UUID userId = getCurrentUserId();
                log.info("Calculating transaction summary for user {} from {} to {}", userId, startDate, endDate);
        ...
        @CacheEvict(cacheNames = {"transactionSummary", "transactionsList", "transactionsByDateRange", "transaction"}, 
